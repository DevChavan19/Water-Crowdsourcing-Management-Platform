package com.watercrowdsourcing.department_service;
...
public class WaterCrowdSourcingDepartmentServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(WaterCrowdSourcingDepartmentServiceApplication.class, args);
	}
