package com.watercrowdsourcing.image_service;
...
public class WaterCrowdSourcingImageServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(WaterCrowdSourcingImageServiceApplication.class, args);
	}
