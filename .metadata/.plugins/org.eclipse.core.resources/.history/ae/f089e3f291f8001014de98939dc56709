package com.watercrowdsourcing.report_service;
...
public class WaterCrowdSourcingReportServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(WaterCrowdSourcingReportServiceApplication.class, args);
	}
