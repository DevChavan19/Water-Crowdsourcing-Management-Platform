package com.watercrowdsourcing.api_gateway.security;
        ...
        SecurityWebFilterChain securityWebFilterChain(
                ...
                http.csrf(ServerHttpSecurity.CsrfSpec::disable)
                                ...
                                .authorizeExchange(auth -> auth
                                                ...
                                                // // admin | patient can check specific patient details, specific
                                                // appointment
                                                // details
                                                // .pathMatchers(HttpMethod.GET,
                                                // "/patients/*","/appointments/patients/**").hasAnyRole("ADMIN","PATIENT")
                                                // // admin | doctor can check specific doc details, specific
                                                // appointment
                                                // details
                                                // .pathMatchers(HttpMethod.GET,
                                                // "/doctors/*","/appointments/doctors/**").hasAnyRole("ADMIN","DOCTOR")
                                                // // only doctor can change appointment status to complete & add some
                                                // diag
                                                // tests
