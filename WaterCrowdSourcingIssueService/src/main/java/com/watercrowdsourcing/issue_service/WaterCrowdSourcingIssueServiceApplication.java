package com.watercrowdsourcing.issue_service;
...
public class WaterCrowdSourcingIssueServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(WaterCrowdSourcingIssueServiceApplication.class, args);
	}
