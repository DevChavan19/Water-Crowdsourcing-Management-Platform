...
import com.watercrowdsourcing.report_service.dtos.AssignIssueRequest;
...
public class ReportController {
    ...
    public ResponseEntity<ApiResponse> verifyReport(
    		@PathVariable Long reportId, @RequestBody @Valid VerifyReportRequest request) {
    ...
    public ResponseEntity<ApiResponse> assignDepartment(
    		@PathVariable Long reportId, @RequestBody @Valid AssignDepartmentRequest request) {
    	return ResponseEntity.ok(reportService.assignDepartment(reportId, request)); 
    	}

    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/{reportId}/assign-issue")
    public ResponseEntity<ApiResponse> assignIssue(
    		@PathVariable Long reportId, @RequestBody AssignIssueRequest request) {
    	return ResponseEntity.ok(reportService.assignIssue(reportId, request.getIssueId())); 
    	}
