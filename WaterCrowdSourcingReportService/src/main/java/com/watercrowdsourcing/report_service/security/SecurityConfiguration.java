    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(request -> request
                        // No truly public endpoints in ReportService currently (everything needs a
                        // role)

                        // Report status updates - allow DEPARTMENT role only
                        .requestMatchers("/reports/*/status").hasRole("DEPARTMENT")

                        // Other report endpoints - ADMIN only
                        .requestMatchers("/reports/**").hasAnyRole("ADMIN", "DEPARTMENT", "USER")
