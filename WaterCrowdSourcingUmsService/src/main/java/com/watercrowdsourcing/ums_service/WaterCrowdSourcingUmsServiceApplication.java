package com.watercrowdsourcing.ums_service;
...
public class WaterCrowdSourcingUmsServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(WaterCrowdSourcingUmsServiceApplication.class, args);
	}
